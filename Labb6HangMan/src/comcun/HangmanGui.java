...
public class HangmanGui {
    ...
    /**
     * Initiliazing GUI Elements on setupGUI()
     */
    ...
    public void setupGame() {
        ...
        int randIndex = rand.nextInt(list.getWordCount() - 1);
    ...
    /**
     * Intializing GUI on setupGUI() method
     * Initializing Game on setupGame() method
     */
    public void startGame() {
        ...
        /**
         * Adding an event for actions that are performed when pressing on the buttons
         */
        submitGuessBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (numOfGuess == 0) {
                    ...
                    if (!guess.equals("") && guess.matches("[A-Za-z]")) {
    ...
    /**
     * Using this method for the tests in HangmanGuiTest class
     * @return
     */
